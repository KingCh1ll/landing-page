...
const terms = [{
    text: 'This privacy policy outlines how we use your data, across all of Ch1llDev\'s websites and Discord bots. By using any of Ch1llDev\'s Services (the "services"), you agree that you have read and accepted both our privacy policy, and the <a href="/legal/tos">Terms of Service</a>. If you have any questions or concerns regarding Ch1llDev\'s policy, you can email Ch1llDev here: <a href="mailto:support@ch1ll.dev">support@ch1ll.dev</a>'
}, {
    header: "1. ⚙️ General"
}, {
    ...
    text: "DisPing stores your data safely and securly in a Mongodb database."
}, {
...
export const metadata = {
    ...
    description: "Read about how we use your data.",
};
