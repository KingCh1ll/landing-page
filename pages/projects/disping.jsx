...
export default function Render() {
    ...
    return (<>
        ...
        <Container maxW={"7xl"} padding={"0 40px"} fontFamily={"Rubik, sans-serif;"}>
            <Navbar name={"KingCh1ll"} logo={"/images/users/kingch1ll.webp"} service={{ name: "DisPing", logo: "/images/disping.png" }} />
                    ...
                    <Stack flex={1} spacing={{ base: 5, md: 10 }}>
                        <Heading lineHeight={1.1} fontWeight={600} fontSize={{ base: "3xl", sm: "4xl", lg: "6xl" }} textAlign={"center"}>
                            ...
                            <Text as={"span"} position={"relative"}>
                                Integrate your socials to Discord. The easy way. That's DisPing.
                            </Text>
                        </Heading>
