...
!(function (e, t) {
    ...
    function v(e, t) {
        ...
        var r = h(e);
        return (
            (e = r === ((o = e.ownerDocument) == null ? void 0 : o.body)),
            (o = n(r)),
    ...
    function y(e) {
        ...
        if (
            o &&
            (s(o) === "html" || (s(o) === "body" && c(o).position === "static"))
        )
            return t;
        if (!o) {
            e: {
                if (
                    ...
                    for (
                        ...
                        if (
                            ...
                            (o && r.willChange === "filter") ||
                            (o && r.filter && r.filter !== "none")
                        ) {
                            o = e;
                            break e;
                        }
        ...
        if (r === "viewport") {
            ...
            i(r)
                ...
                : ((u = f(e)),
                  (e = f(u)),
                  (s = o(u)),
                  (r = (a = u.ownerDocument) == null ? void 0 : a.body),
                  (a = _(
                      e.scrollWidth,
                      e.clientWidth,
                      r ? r.scrollWidth : 0,
    ...
    function P(e) {
        ...
        if ((o = o ? L(o) : null) != null) {
            switch (((i = o === "y" ? "height" : "width"), e)) {
                case "start":
                    r[o] -= t[i] / 2 - n[i] / 2;
                    break;
                case "end":
    ...
    function A(e, n) {
        ...
        var p = o.altBoundary,
            c = void 0 !== p && p;
        o = M(
            typeof (o = void 0 === (o = o.padding) ? 0 : o) !== "number"
                ? o
                : k(o, C)
        );
                ...
                c = {
                    ...
                    setOptions: function (i) {
                        return (
                            ...
                            (s.orderedModifiers = i.filter((e) => e.enabled)),
    ...
    function q(e) {
        return ["top", "right", "bottom", "left"].some((t) => e[t] >= 0);
    }
    var C = ["top", "bottom", "right", "left"],
        N = C.reduce((e, t) => e.concat([`${t}-start`, `${t}-end`]), []),
        V = []
            .concat(C, ["auto"])
            .reduce((e, t) => e.concat([t, `${t}-start`, `${t}-end`]), []),
        I =
                ...
                if (((s = { x: 0, y: 0 }), a)) {
                    if (r || i) {
                        ...
                        (v = P[v]),
                            ...
                            i &&
                                ((r =
                                    (i = a[n]) + f[l === "x" ? "top" : "left"]),
                                (f = i - f[l === "x" ? "bottom" : "right"]),
                                (r = o ? U(r, c) : r),
                                (o = o ? _(f, u) : f),
                                (o = _(r, U(i, o))),
                                (a[n] = o),
        ...
        oe = {
            ...
            fn: function (e) {
                ...
                if (
                    ((e = L(s)),
                    (s =
                        ["left", "right"].indexOf(s) >= 0 ? "height" : "width"),
                    i && a)
                ) {
                    r = M(
                        typeof (r =
                            typeof (r = r.padding) === "function"
                                ? r(
