!(function (e, t) {
    ...
    var _ = (function () {
        function e(i, n) {
            ...
            var s = function () {};
            (this.rotate = D(this.element, n.rotate || s)), (this.touchStart = D(this.element, n.touchStart || s)), (this.multipointStart = D(this.element, n.multipointStart || s)), (this.multipointEnd = D(this.element, n.multipointEnd || s)), (this.pinch = D(this.element, n.pinch || s)), (this.swipe = D(this.element, n.swipe || s)), (this.tap = D(this.element, n.tap || s)), (this.doubleTap = D(this.element, n.doubleTap || s)), (this.longTap = D(this.element, n.longTap || s)), (this.singleTap = D(this.element, n.singleTap || s)), (this.pressMove = D(this.element, n.pressMove || s)), (this.twoFingerPressMove = D(this.element, n.twoFingerPressMove || s)), (this.touchMove = D(this.element, n.touchMove || s)), (this.touchEnd = D(this.element, n.touchEnd || s)), (this.touchCancel = D(this.element, n.touchCancel || s)), (this._cancelAllHandler = this.cancelAll.bind(this)), window.addEventListener("scroll", this._cancelAllHandler), (this.delta = null), (this.last = null), (this.now = null), (this.tapTimeout = null), (this.singleTapTimeout = null), (this.longTapTimeout = null), (this.swipeTimeout = null), (this.x1 = this.x2 = this.y1 = this.y2 = null), (this.preTapPosition = { x: null, y: null });
        }
        return (
            n(e, [
                {
