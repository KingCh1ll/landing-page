                    ...
                    <div style={{ paddingTop: "8rem", paddingBottom: "3rem" }}>
                        <div style={{ backgroundColor: "rgb(0, 10, 35)", maxWidth: "575px", margin: "auto", padding: "20px", borderRadius: "20px" }}>
                            ...
                            <div className="aos-init aos-animate" style={{ color: "rgba(255, 255, 255, 1)", textAlign: "center" }} data-aos="zoom-in">
                                <p className="aos-init aos-animate" style={{ fontSize: "17px" }} data-aos="zoom-in">Hi, I'm KingCh1ll! I'm a passionate <strong>Software Engineer</strong>, living in the <strong>United States</strong>. I love making <strong>websites</strong> (<a href="https://www.sparkv.tk/">SparkV's Site</a>, <a href={"https://surfhost.us/"}>Surf Host</a>) and <strong>Discord bots</strong> (<a href="https://www.sparkv.tk/">SparkV</a>). I also used to make games on the platform <a href="https://roblox.com">Roblox</a>.</p>
                                <p className="aos-init aos-animate" style={{ fontSize: "17px" }} data-aos="zoom-in">In my free time I like to code, chat with friends, play my guitar, or go on runs.</p>
